...
const AttendanceCheckin: React.FC<AttendanceCheckinProps> = ({ operatorName, onClockIn }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 p-4">
      <div className="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700 text-center animate-fade-in-up">
        ...
        <p className="text-lg text-gray-400 mb-8">Daily Check-in for {today}</p>
