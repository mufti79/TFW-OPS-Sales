      ...
      <div className="mb-4 p-3 bg-teal-900/30 border border-teal-700/50 rounded-lg">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-gray-300">
            <span className="font-semibold text-teal-400">Note:</span> For best workflow, use TFW-NEW app for making assignments. Changes will automatically sync to this app and be visible to ticket sales personnel.
          </div>
        </div>
      </div>
