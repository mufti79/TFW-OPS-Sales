        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center ml-4 md:ml-6 space-x-4">
            ...
            <div className="ml-3 relative flex items-center">
              ...
              <button onClick={onLogout} title="Logout" className="ml-4 p-2 rounded-full text-gray-300 bg-red-600 hover:bg-red-700">
        ...
        <div className="md:hidden" id="mobile-menu">
          ...
          <div className="pt-4 pb-3 border-t border-gray-700">
            <div className="flex items-center justify-between px-5">
              ...
              <button onClick={onLogout} className="flex-shrink-0 bg-red-600 p-2 rounded-md text-white hover:bg-red-700">
                Logout
              </button>
            </div>
